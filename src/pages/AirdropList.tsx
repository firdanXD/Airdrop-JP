...
export const AirdropListPage = () => {
    ...
    return (
        <div className="p-4 md:p-8">
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4"><h1 className="font-space-grotesk text-5xl font-bold text-center md:text-left">Airdrop List</h1><div className="flex flex-col sm:flex-row gap-2"><Button onClick={handleExport} className="bg-green-400 hover:bg-green-500 w-full"><span className="flex items-center justify-center gap-2"><Download size={16}/> Export XLSX</span></Button><Button onClick={() => setModalState({type: 'form'})} className="w-full"><span className="flex items-center justify-center gap-2"><Plus /> Add New</span></Button></div></div>
